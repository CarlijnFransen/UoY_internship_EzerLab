...
for sample in sample_folders:
    if sample.startswith("."):
        pass
    elif sample.endswith("C"):
        pass   
    elif sample.endswith("_C_concatenated_4"):
        pass
    else:
        if sample.strip().endswith("_concatenated_4"):
            ...
            short_sample = sample
        short_sample_no_c = short_sample.rstrip("_T")
...
complete_tpm_table.to_csv('tnz_ws2_ril_TPM_table_only_treatment_1.csv',  index=False, header=True)
